let pokemon = [
  ...
  },
  {
    ...
    // move1: "https://pokeapi.co/api/v2/move/5/",
    // move2: "https://pokeapi.co/api/v2/move/8/"
  },
  {
    name: "Charmander",
    bio:
    ...
    // move1: "https://pokeapi.co/api/v2/move/5/",
    // move2: "https://pokeapi.co/api/v2/move/7/"
  },
  {
    name: "Beedrill",
    bio:
    ...
    // move1: "https://pokeapi.co/api/v2/move/14/",
    // move2: "https://pokeapi.co/api/v2/move/15/"
  }
];
...
for (let i = 0; i < pokemon.length; i++) {
  ...
  //   let move1 = document.createElement("move1");
  //   move1.innerText = pokemon[i].move1;

  //   let move2 = document.createElement("move2");
  //   move2.innerText = pokemon[i].move2;
  ...
  let showPokemon = function(e) {
    ...
    fetch(pokemon[i].url)
      ...
      .then(res => {
        ...
        primaryAbility1.textContent = res.abilities[0].ability.name;
...
//   .then(res1 => res1.json())
//   .then(res1 => {
//     // primaryAbility1.textContent = res1.name;
//   })
//   .catch(err => console.log("Oops! Pokeball unavailable. Try again!", err));
...
//   .then(res2 => res2.json())
//   .then(res2 => {
//     primaryAbility2.textContent = res2.name;
//   })
//   .catch(err => console.log("Oops! Pokeball unavailable. Try again!", err));

//     fetch(pokemon[i].move1)
//       .then(res3 => res3.json())
//       .then(res3 => {
//         primaryMove1.textContent = res3.name;
//       })
//       .catch(err => console.log("Oops! Pokeball unavailable. Try again!", err));

//     fetch(pokemon[i].move2)
//       .then(res4 => res4.json())
//       .then(res4 => {
//         primaryMove2.textContent = res4.name;
//       })
//       .catch(err => console.log("Oops! Pokeball unavailable. Try again!", err));
//   };
